...
public class InitialDataLoader implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		// 1 //Admin
		User admin = new User("niketa@lambton.com", "Niketa", "lambton", "images/niketa.png");
		userService.createUser(admin);
		userService.changeRoleToAdmin(admin);

		// 2
		userService.createUser(new User("saurav@lambton.com", "Saurav", "lambton", "images/saurav.png"));

		// 3
		userService.createUser(new User("crisel@lambton.com", "Criselda", "lambton", "images/crisel.png"));

		// 4
		userService.createUser(new User("reea@lambton.com", "Reea", "lambton", "images/reea.png"));

		// 5
		userService.createUser(new User("sujita@lambton.com", "Sujita", "lambton", "images/sujita.png"));

		// 7
		// Admin 2
		userService.changeRoleToAdmin(
				userService.createUser(new User("rajwant@lambton.com", "Rajwant", "lambton", "images/rajwant.png")));
		...
		// 1
		taskService.createTask(new Task("Collect project report",
				...
				userService.getUserByEmail("crisel@lambton.com")));
		...
		taskService.createTask(new Task("Create Project UI template",
				...
				userService.getUserByEmail("saurav@lambton.com")));
		...
		taskService.createTask(new Task("Priority Module", "Setting task priorities\r\n" + "Sorting tasks by priority",
				...
				userService.getUserByEmail("rajwant@lambton.com")));
		...
		taskService.createTask(new Task("Search and Filter Module:",
				...
				userService.getUserByEmail("sujita@lambton.com")));
		...
		taskService.createTask(new Task("Scheduling Module:",
				...
				userService.getUserByEmail("reea@lambton.com")));
		...
		taskService.createTask(
				new Task("Grade Assignment 1", "Grade all students assignment 1 and provide detailed feedback",
						...
						userService.getUserByEmail("niketa@lambton.com")));
